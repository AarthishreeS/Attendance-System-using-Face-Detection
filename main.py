...
def Display():
    ...
    if (password == key):
        with open(r'Attendance\Attendance_24-04-2023.csv') as f:
            ...
            for row in reader:
                ...
                Date = row['Date']
                Time = row['Time']
                tv1.insert("", 0, values=(Id, Name, Date, Time))
        f.close()
    elif (password == None):
        pass
    else:
...
###################################################################################
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'f20200639@hyderabad.bits-pilani.ac.in,f20200479@hyderabad.bits-pilani.ac.in' ")
###################################################################################
...
def search(target_node):
    ...
    with open(r'Attendance\Attendance_24-04-2023.csv') as file_obj:
        ...
        return "Last entry : " + result.data[4] + "   " +  result.data[6]
...
window = tk.Tk()
window.geometry("25000x720")
window.resizable(True,False)
window.title("Attendance System")
window.configure(background='#262523')

frame1 = tk.Frame(window, bg="#00aeff")
frame1.place(relx=0.0025, rely=0.17, relwidth=0.33, relheight=0.80)

frame2 = tk.Frame(window, bg="#00aeff")
frame2.place(relx=0.34, rely=0.17, relwidth=0.33, relheight=0.80)

frame5 = tk.Frame(window, bg="#00aeff")
frame5.place(relx=0.68, rely=0.17, relwidth=0.51, relheight=0.80)
...
#frame6 = tk.Frame(window, bg="#c4c6ce")
#frame6.place(relx=0.20, rely=0.09, relwidth=0.23, relheight=0.07)
...
head1 = tk.Label(frame5, text="                           For Faculty Access                           ", fg="black",bg="#3ece48" ,font=('times', 17, ' bold ') )
head1.place(x=0,y=0)
...
lbl = tk.Label(frame5, text="Enter ID",width=20  ,height=1  ,fg="black"  ,bg="#00aeff" ,font=('times', 17, ' bold '))
lbl.place(x=80, y=55)

#message1.place(x=80, y=45)

txt3 = tk.Entry(frame5,width=32 ,fg="black",font=('times', 15, ' bold '))
txt3.place(x=30, y=88)
...
message3 = tk.Label(frame5, text = "" ,font=('times', 15, ' bold '))
message3.place(x=80, y=128)
...
tv1= ttk.Treeview(frame5,height =13,columns = ('Id','name','date','time'), show='headings')
tv1.column('#1',width=82)
tv1.column('#2',width=130)
tv1.column('#3',width=133)
tv1.column('#4',width=133)
tv1.grid(row=2,column=0,padx=(0,0),pady=(180,0),columnspan=4)
tv1.heading('#1',text ='ID')
tv1.heading('#2',text ='NAME')
tv1.heading('#3',text ='DATE')
tv1.heading('#4',text ='TIME')

###################### SCROLLBAR ################################

scroll=ttk.Scrollbar(frame5,orient='vertical',command=tv1.yview)
scroll.grid(row=2,column=4,padx=(0,150),pady=(180,0),sticky='ns')
...
clearButton0 = tk.Button(frame5, text="Search", command=searchID  ,fg="black"  ,bg="#ea2a2a"  ,width=11 ,activebackground = "white" ,font=('times', 11, ' bold '))
clearButton0.place(x=335, y=86)   
...
Window = tk.Button(frame5, text="Display", command=Display  ,fg="black"  ,bg="red"  ,width=35 ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
Window.place(x=30, y=500)
